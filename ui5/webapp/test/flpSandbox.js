		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind Product",
									"targetURL": "#NorthwindProduct-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"NorthwindProduct-display": {
								"semanticObject": "NorthwindProduct",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=au.com.tri.ui5",
									"url": sap.ui.require.toUrl("au/com/tri/ui5")
								}
							}
						}
					}
